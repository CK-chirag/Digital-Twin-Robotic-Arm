...
def generate_launch_description():
    ...
    gazebo_resource_parent_path = os.path.dirname(pkg_share_description)
    ...
    # Add package parent so model://mycobot_description/... resolves correctly.
    set_env_vars_description = AppendEnvironmentVariable(
        'GZ_SIM_RESOURCE_PATH',
        gazebo_resource_parent_path)
    ...
    ld.add_action(set_env_vars_description)
